...
export default function DevolucionesPage() {
  ...
  if (lotes.length === 0) {
    return <EmptyState title="Sin lotes disponibles" description="No hay lotes con stock para devolver." />;
  }

  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-peach-200 bg-white p-5">
        <h2 className="mb-4 text-base font-bold text-wine-900">Registrar Devolución a Proveedor</h2>
